...
urlpatterns = [
    ...
    path('collections/delete_block/<int:noteblock_id>',views.delete_block,name='delete_noteblock'),
    path('collections/delete_index/<int:noteIndex_id>',views.delete_blockIndex,name='delete_blockIndex'),
