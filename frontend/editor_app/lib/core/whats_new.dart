...
/// editor feature; keep descriptions to one or two sentences. Entries
...
const _kFeatureUpdates = <FeatureUpdate>[
  FeatureUpdate(
    version: '0.1.123',
    title: 'Private category subscriptions',
    description: 'Cloud categories can now be subscribed privately so '
        'they do not appear on your public profile.',
    icon: Icons.lock_outline,
  ),
  FeatureUpdate(
    version: '0.1.123',
    title: 'Apple Journal import (experimental)',
    description: 'Import an Apple Journal ZIP export as local drafts '
        'from Settings > Developer settings. Sync stays paused until '
        'you push manually.',
    icon: Icons.upload_file_outlined,
  ),
  FeatureUpdate(
    version: '0.1.125',
    title: 'Note deep links',
    description: 'Opened notes keep a #/notes/<id> URL you can bookmark '
        'and share; private notes prompt for sign-in instead of '
      ...
      unawaited(() async {
        ...
        log(
          ...
          message:
              ...
              'Editor.UI/whats_new — ${missed.length} update(s) since '
  ...
  Future<void> _stampWhatsNewVersion(String version) async {
    ...
    try {
      ...
      log(
        ...
        source: 'Editor.Sync.Settings',
        message: 'Seen-version not saved to profile: '
            'Editor.Sync.Settings/save — $cause. The overlay will not '
