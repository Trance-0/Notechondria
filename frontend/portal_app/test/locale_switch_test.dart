...
/// Verifies the portal Language setting end-to-end: with `locale: zh`
...
void main() {
  testWidgets('persisted locale=zh boots the portal in Chinese',
      (tester) async {
    SharedPreferences.setMockInitialValues({
      'notechondria.portal.local_settings': jsonEncode({
        'offline_mode': true,
        'locale': 'zh',
      }),
    });
