...
/// portal feature; keep descriptions to one or two sentences. Entries
...
const _kFeatureUpdates = <FeatureUpdate>[
  ...
  FeatureUpdate(
    ...
    description: 'Settings now has a Language row — switch the portal '
      ...
      unawaited(() async {
        ...
        log(
          ...
          message:
              ...
              'Portal.UI/whats_new — ${missed.length} update(s) since '
  ...
  Future<void> _stampWhatsNewVersion(String version) async {
    ...
    try {
      ...
      log(
        ...
        source: 'Portal.Sync.Settings',
        message: 'Seen-version not saved to profile: '
            'Portal.Sync.Settings/save — $cause. The overlay will not '
