...
/// Internal HTTP plumbing for `HttpNotechondriaClient` (planner_app).
/// URL construction, response decoding, shaped-error wrapping,
/// request wrapper with debug logging, verb helpers, header
/// builder, debug-snapshot ring. None of these are part of the
/// `NotechondriaClient` interface (all private `_`-prefixed), so
/// they move cleanly into an extension. Extracted from
/// `core/client.dart` so that file stays closer to the AGENTS.md
